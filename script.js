(function(){
  ...
  var PRODUCTS = [
    ...
    {key:'p8', icon:'<line x1="4" y1="6" x2="20" y2="6"/><circle cx="9" cy="6" r="2"/><line x1="4" y1="12" x2="20" y2="12"/><circle cx="15" cy="12" r="2"/><line x1="4" y1="18" x2="20" y2="18"/><circle cx="11" cy="18" r="2"/>'},
  ...
  var T = {
    ru:{
      ...
      p4t:'1С:ERP', p4d:'Внедрение и сопровождение ERP-решений для комплексной автоматизации бизнеса.',
      p8t:'1С:Управление предприятием', p8d:'Решения для автоматизации операционного управления, учёта, контроля и планирования деятельности предприятия.',
      ...
      procEyebrow:'Как мы работаем', procTitle:'Пять шагов от заявки до запущенной системы', procCta:'Обсудить ваш проект',
    ...
    uz:{
      ...
      p4t:'1C: ERP', p4d:"Biznesni kompleks avtomatlashtirish uchun ERP-yechimlarini joriy etamiz va qo'llab-quvvatlaymiz.",
      p8t:'1C: Korxonani boshqarish', p8d:"Korxona faoliyatini operativ boshqarish, hisobga olish, nazorat va rejalashtirishni avtomatlashtirish yechimlari.",
